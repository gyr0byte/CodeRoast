...
NEPALI_ROAST_TEMPLATES = {
    ...
    2: [
        ...
        "Yo function padhda padhdai mero 2 barsa ko aayush ghatyo, you dumbass! Duplicate logic le garda maintenance nightmare banisakechha. Sancho lagaye pani yo code le dieko headache thik hudaina. Clean up your architecture right fucking now!",
