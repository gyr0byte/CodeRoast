...
NEPALI_ROAST_TEMPLATES = {
    ...
    3: [
        ...
        "What an absolute abominable atrocity! Tero code architecture dekhera CPU le thermal throttling garera shutdown handyo. Rajesh Hamal (Maha-Nayak) le 100 meter bata dhungga fyalera tero screen phodchha if you don't delete this repository. Shut down VS Code forever, you dimag navako radi ko baan!",
        ...
        "Jesus Christ, yo snippet padhera mero brain cell million wota dead vayo! Infinite memory leak, undefined variable references, ra total architectural disaster. Format drive D:\\, throw your laptop into Karnali river, and go herd Yaks in Manang, you hopeless radi ko tokeri!",
        "Holy fucking mother of disasters! Tero code dekhera Harke Sampang le Dharan ma dhungga boke jastai tero RAM ra CPU le yo logic run garna dhungga bokna parya chha, you dimag navako gadha! Prakash Saput ko song 'Sakambhari' jastai dramatic crisis banaye'chhas function ma. 100kg gold scam bhanda thulo scam ho tero computer science degree. Delete gar yo clusterfuck immediately ra laptop fyal Bagmati ko fohor paani ma, you absolute radi ko tokeri!",
        ...
        "Holy motherfucking disaster! Tero function ma logic chhaina, Samsad bhaban ko hawa halla ra fight bhanda worst chaos chha, pasa! Vten le rap spit gare jasto mero terminal le profanity spit garyo tero code dekhera. InDrive ride 10 choti cancel bhaye jastai compiler le 10 choti crash report garyo. Delete your GitHub account right now, close your laptop, and never code again in this lifetime, you harami radi ko tokeri!",
        ...
        "What an absolute abominable clusterfuck! Tero cyclomatic complexity dekhera NASA ko supercomputer pani crash hunchha! KP Oli ko gaff jastai zero substance, pure noise. Hard drive format garera laptop Pokhara ko Fewa Lake ma fyal, you harami radi ko tokeri!",
        ...
        "Arey radi ko baan, yo snippet padhera mero eye doctor le visual disability certificate diyo! 12 level deep nesting, zero comments, ra pure chaos. Delete your GitHub account immediately, you absolute failure of a developer!",
    ],
}
