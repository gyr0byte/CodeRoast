...
ROAST_TEMPLATES = {
    ...
    "high_complexity": [
        ...
        "This code has more branches than a decision tree. "
        "Actually, it IS a decision tree. A bad one.",

        "I counted {score} paths through this function. "
        "NASA uses fewer trajectories to reach Mars.",

        "Your if-else chain is so long, it has its own table of contents.",

        "This function doesn't need a refactor. "
    ...
    "bad_naming": [
        ...
        "Using single-letter variable names is not 'minimalism'. "
        "It is 'job security through obscurity'.",

        "Your naming convention appears to be 'keyboard smash'. "
        "Innovative, but not recommended.",

        "I've seen better naming conventions in a toddler's crayon drawings.",

        "Your variables are named like witness protection participants. "
    ...
    "no_comments": [
        ...
        "This code has fewer comments than a library during finals week. "
        ...
        "Comment ratio: {ratio}%. "
        "That is not minimalism. That is negligence.",
    ],
    ...
    "too_long": [
        ...
        "Your function is {lines} lines. "
        "That is not a function. That is a short story.",

        "I've read novellas shorter than this function. "
        "At least those had character development.",

        "This function is so long, it should have its own README.",

        "{lines} lines in one function. "
        "The Single Responsibility Principle just filed a restraining order.",
    ],

    # ── Deep Nesting ─────────────────────────────────────────────────────
    "deep_nesting": [
        "Nesting depth: {depth}. "
        "This code is deeper than my existential crisis.",

        "I found {depth} levels of nesting. "
        "Even Inception only went 4 levels deep.",

        "Your indentation goes so far right, "
        "it is about to fall off the screen.",

        "This nesting depth qualifies as a spelunking expedition. "
        "Bring a headlamp.",

        "Arrow code detected. Your code points to the right "
        "like it is trying to escape the file.",
    ],

    # ── Duplicate Code ───────────────────────────────────────────────────
    "duplicate_code": [
        "I found duplicate code blocks. "
        "Copy-paste is not a design pattern.",

        "This code has more repetition than a pop song chorus. "
        "At least pop songs are catchy.",

        "DRY stands for Don't Repeat Yourself. "
        "Apparently you thought it meant Do Repeat Yourself.",

        "Your code has the same block repeated multiple times. "
        "Functions exist. Use them.",

        "I see you believe in the ancient art of copy-paste engineering. "
        "Bold strategy.",
    ],

    # ── Too Few Functions ────────────────────────────────────────────────
    "too_few_functions": [
        "Your entire program is in one function. "
        "That is not code. That is a monologue.",

        "Function count: {count}. "
        "Even 'Hello World' programs have more structure.",
        ...
        "You wrote {lines} lines with {count} function(s). "
        "That ratio concerns me deeply.",
    ],
    ...
    "praise": [
        ...
        "I... I don't have anything mean to say. "
        "This is a first. Are you a compiler in disguise?",

        "Well-structured, well-named, well-commented. "
        "Who hurt you into writing good code?",

        "Your code is clean. Suspiciously clean. "
        "I will be watching you.",

        "This code is so clean, it made me question "
        "my purpose as a roasting AI.",
    ],
    ...
    "general": [
        ...
        "On a scale of 'beautiful' to 'war crime', "
        "this is somewhere around 'parking violation'.",

        "I have seen things. Your code is now one of those things.",

        "This code passes. Like a kidney stone passes. "
        "Technically successful, but painful for everyone involved.",

        "Your code is like a mystery novel. "
        "No one knows what it does, including the author.",
    ],

    # ── Syntax Error ─────────────────────────────────────────────────────
    "syntax_error": [
        "Your code has a syntax error. "
        "I cannot roast what cannot run.",

        "SyntaxError detected. The code roasted itself. "
        "My work here is done.",

        "I tried to analyze your code, but Python refused to parse it. "
        "Even the interpreter gave up on you.",

        "Your code has syntax errors. "
        "It is not just bad code. It is not even code.",
    ],
}
